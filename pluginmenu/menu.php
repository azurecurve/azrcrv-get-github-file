 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_gghf')){
	function azrcrv_create_plugin_menu_gghf(){
		azrcrv_create_plugin_menu_table_gghf();
		azrcrv_populate_plugin_menu_table_gghf();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_gghf')){
	function azrcrv_populate_plugin_menu_table_gghf(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_gghf')){
	function azrcrv_create_plugin_menu_table_gghf(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
